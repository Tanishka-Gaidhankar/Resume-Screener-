    ...
    def _call_groq(
        ...
        *,
        ...
        user_prompt = (
            ...
            "INSTRUCTIONS:\n"
            "1. Extract candidate fields in an object named 'fields':\n"
            "   - 'applicant_name': Candidate's full name (e.g. 'Aniket Arun Lokhande', or '' if not found).\n"
            "   - 'email_id': Candidate's email address (e.g. 'aniketlokhande148@gmail.com', or '' if not found).\n"
            "   - 'phone_number': Candidate's phone number (e.g. '7058737974', or '' if not found).\n"
            "   - 'designation': Candidate's target role or designation (e.g. 'Civil Engineer', 'R.C.C. Draughtsman', or '' if not found).\n"
            ...
            "   - MUST start directly with the title 'AI Analysis'.\n"
            "   - Include Match Status (e.g. Match / No Match / May be), Matched Role (if any), and a clear explanation of how the candidate's background, qualifications, and skills align or do not align with the job description.\n\n"
